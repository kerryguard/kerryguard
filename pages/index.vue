    ...
    <section class="py-20 2xl:py-40 bg-gray-800 overflow-hidden">
      <div class="container px-4 mx-auto">
        <div class="max-w-3xl mx-auto text-center">
          <h2
            class="mb-14 text-6xl lg:text-7xl font-bold font-heading text-white"
          >
            We are Zospace. Founded in London
          </h2>
          <div class="inline-flex mb-14 lg:mb-20 items-center">
            ...
            <div class="text-left">
              ...
              <p class="text-white">20 april, 8:30 am</p>
            </div>
          </div>
        </div>
        <div class="relative h-96 mb-20">
          <img
            ...
            src="https://images.unsplash.com/photo-1517171771326-cbc7f641008a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1200&amp;q=80"
            alt=""
          />
          <img
            class="
              ...
              object-cover
            "
            src="https://images.unsplash.com/photo-1618938700817-fe48bd93f20b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80"
            alt=""
          />
        </div>
