<template>
  <footer class="py-20 2xl:py-40 bg-gray-800">
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap -mx-4 pb-6 lg:pb-20 border-b border-gray-500">
          ...
          <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-1/2 lg:w-1/3 px-4 mb-12">
              ...
              <ul class="text-lg">
                ...
                <li>
                  <a class="text-gray-200 hover:text-gray-100" href="#">Team</a>
                </li>
              </ul>
            </div>
        ...
        <div
          class="w-full lg:w-2/5 px-4 order-first lg:order-last mb-16 lg:mb-0"
        >
          <h3 class="mb-16 text-xl font-bold text-white">Newsletter</h3>
          <form action="#">
            <div class="max-w-sm mb-8 flex items-center bg-white rounded-full">
              ...
              <input
                class="pl-4 py-5 rounded-full placeholder-gray-900 font-bold"
                type="email"
